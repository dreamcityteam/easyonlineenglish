...
module.exports = (req, res, next) => {
	...
	/*if (
		isEndpoint(ENDPOINT.CONTANCT) ||
		isEndpoint(ENDPOINT.SUSCRIBETE) ||
		isEndpoint(ENDPOINT.AZUL_PAYMENT_3DS) ||
		isEndpoint(ENDPOINT.AZUL_PAYMENT_3DS_RESPONSE) ||
		isEndpoint(ENDPOINT.AZUL_PAYMENT_3DS_NOTIFICATION) || 
  ...
  return next();
	...
	if (tokenFromHeader && (isEndpoint(ENDPOINT.RESET_PASSWORD_AUTH) || isEndpoint(ENDPOINT.RESET_PASSWORD))) {
